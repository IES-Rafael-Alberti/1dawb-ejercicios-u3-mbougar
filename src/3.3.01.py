...
"""
def crear_conjunto_domicilio(lista_compras: list) -> set:
    conjunto_domicilio = set()
    
    for item in range(len(lista_compras)):
        conjunto_domicilio.add(lista_compras[item][3])
    
    return conjunto_domicilio


def main():
    lista_compras = [("Nuria Costa", 5, 12780.78, "Calle Las Flores 355"), ("Jorge Russo", 7, 699, "Mirasol 218"), ("Nuria Costa", 7, 532.90, "Calle Las Flores 355"), ("Julián Rodriguez", 12, 5715.99, "La Mancha 761"), ("Jorge Russo", 15, 958, "Mirasol 218")]

    domicilios = crear_conjunto_domicilio(lista_compras)
